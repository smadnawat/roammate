...
@service_point1 = ServicePoint.create(service: "Signup", point: "50")
@service_point2 = ServicePoint.create(service: "Chat", point: "20")
@service_point3 = ServicePoint.create(service: "Send invitation", point: "10")
@service_point4 = ServicePoint.create(service: "Recieve invitation", point: "10")
@service_point5 = ServicePoint.create(service: "Feedback", point: "20")
@service_point6 = ServicePoint.create(service: "First City", point: "150")
@service_point7 = ServicePoint.create(service: "Rate", point: "70")
@service_point8 = ServicePoint.create(service: "Interest", point: "80")
@service_point9 = ServicePoint.create(service: "Post", point: "50")
@service_point10 = ServicePoint.create(service: "Share", point: "200")