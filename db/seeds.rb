...
@profile1 = Profile.create(email: "#{@user1.user_id}@facebook.com", first_name: "user", last_name: "1", gender: "male", status: false, user_id: 1)
@profile2 = Profile.create(email: "#{@user2.user_id}@facebook.com", first_name: "user", last_name: "2", gender: "male", status: false, user_id: 2)
@profile3 = Profile.create(email: "#{@user3.user_id}@facebook.com", first_name: "user", last_name: "3", gender: "male", status: false, user_id: 3)
...
@question1 = @category1.questions.create(question: "This is question 1?")
@question2 = @category1.questions.create(question: "This is question 2?")
@question3 = @category2.questions.create(question: "This is question 3?")
@question4 = @category2.questions.create(question: "This is question 4?")
@question5 = @category3.questions.create(question: "This is question 5?")
@question6 = @category3.questions.create(question: "This is question 6?")
@question7 = @category4.questions.create(question: "This is question 7?")
@question8 = @category4.questions.create(question: "This is question 8?")
@question9 = @category5.questions.create(question: "This is question 9?")
@question10 = @category5.questions.create(question: "This is question 10?")
